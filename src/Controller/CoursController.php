...
class CoursController extends AbstractController
{
    ...
    #[Route('/client', name: 'app_cours_liste', methods: ['GET'])]
    public function indexclient(CoursRepository $coursRepository): Response
    {
        return $this->render('cours/indexclient.html.twig', [
            'cours' => $coursRepository->findAll(),
        ]);
    }
